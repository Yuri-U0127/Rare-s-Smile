  ...
  return (
    <>
      {matches ?
        ...
        :
        <div className="h-[100px] flex w-[400px] justify-center">
          <div className=" border-b-1 border-[white] bg-[#22998D] rounded-l-[10px] text-white">
            <div className="w-fit mx-auto">累計開始日</div>
            <div className="w-fit mx-auto"><span className="font-bold">2021.03.05</span></div>
          </div>
          <div className="bg-[#D4F2EF] rounded-r-[10px]">
