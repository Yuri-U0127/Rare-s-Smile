...
const StyledButton = styled(Button)(({ width, height, isDelete, borderradius, fontSize, display, padding }) => ({
  ...
  backgroundColor: isDelete ? "#DD3A3A" : "white",
  color: isDelete ? "white" : "#46D0C9",
  borderRadius: borderradius || "30px",
  fontWeight: "bold",
  fontSize: fontSize || "16px",
  border: isDelete ? "none" : "3px solid #46D0C9",
  borderImage: "linear-grandient(right ,#75D1C1, #034B44)",
  borderImageSlice: "1",
  width: width || "auto",
  height: height || "40px",
  boxShadow: isDelete ? "0px 2px 5px rgba(0, 0, 0, 0.15)" : "none",
  textTransform: "none",
  ...
  "&:hover": {
    boxShadow: isDelete ? "1px 1px 10px  #aaaaaa" : "3px 3px 10px #22998D",
